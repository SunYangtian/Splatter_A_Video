...
from .point import PointRAFTExhaustiveDataset
from .gs_data import GSRAFTExhaustiveDataset
from .gs_data2 import GSSimpleDataset
...
dataset_dict = {
    ...
    'point': PointRAFTExhaustiveDataset,
    'gaussian': GSRAFTExhaustiveDataset,
    'simpleGS': GSSimpleDataset,
}
