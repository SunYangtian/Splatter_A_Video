...
UNIDEPTH_PATH = '/mnt/sdc/syt/code/UniDepth'
import sys
sys.path.append(UNIDEPTH_PATH)
UNIDEPTH_CKPT_PATH = "/mnt/sdb/syt/pretrained_weights/unidepth-v2-vitl14/"
...
def run_model_inference(img_dir: str, depth_dir: str, intrins_file: str):
    ...
    model = UniDepthV2.from_pretrained(UNIDEPTH_CKPT_PATH)
